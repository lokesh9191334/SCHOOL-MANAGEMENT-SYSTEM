...
const PromotionsModule = ({
  ...
  const currentModule = module; // Use the module prop directly
      ...
      <section className="content-grid">
        <article className="panel-card data-panel">
          <div className="panel-header">
            <div>
              ...
              <h3>{currentModule.title} Records</h3>
            </div>
            ...
            <article className="panel-card info-panel">
              ...
              <div className="panel-content">
                <ol className="workflow-list">
                  {currentModule.workflow.map((step, index) => (
        ...
        <section className="bottom-grid">
          <article className="panel-card trend-panel">
            <div className="panel-header">
              <h3>{currentModule.trendLabel}</h3>
            </div>
            <div className="panel-content">
              <TrendChart />
            </div>
          ...
          <article className="panel-card automation-panel">
            ...
            <div className="panel-content">
              <RingChart totalText={currentModule.ring.total} subtitle={currentModule.ring.subtitle} />
